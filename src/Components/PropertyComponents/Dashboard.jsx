...
import { fetchAllDatasDashboardApi } from '../../Api/PropertyApi';
...
export default function Dashboard() {
    ...
    const owner = useSelector((state) => state.owner.id);
    ...
    if (totalRevenue.length > 0) {
        options = {
            data: totalRevenue.map(({ month, revenue, year }) => ({
                month: `${month}-${year}`,
                revenue: revenue,
            })),
            series: [{
            ...
            {loading ? (
                <div className="pt-0">
                    <div className="p-4 h-screen dark:border-gray-700">
                        ...
                        <div className="shadow-lg rounded p-3 w-full md:w-1/2 h-[65%] bg-white">
